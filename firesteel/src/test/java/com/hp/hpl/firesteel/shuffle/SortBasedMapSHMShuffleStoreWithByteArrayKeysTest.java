...
public class SortBasedMapSHMShuffleStoreWithByteArrayKeysTest extends TestCase {

	 private static final Logger LOG = 
			          LoggerFactory.getLogger(SortBasedMapSHMShuffleStoreWithByteArrayKeysTest.class.getName());
	 ...
	 /**
	  *to test Shuffle Store Manager's load library, init and then shutdown for ByteArray Keys based store.
	  */
	 @Test
	 public void testShutdownMapShuffleStoreManagerWithByteArrayKeys() {
		 
		 LOG.info("this is the test for testShutdownMapShuffleStoreManagerWithByteArrayKeys");
	 ...
	 @Test
	 public void testShutdownMapShuffleStoreManagerSerializerAndStoreWithByteArrayKeysTestWithoutClassRegistration() {
		 LOG.info("this is the test for testShutdownMapShuffleStoreManagerSerializerAndStoreWithByteArrayKeysTestWithoutClassRegistration");
	 ...
	 @Test
	 public void testShutdownMapShuffleStoreManagerSerializerAndStoreWithByteArrayKeysWithClassRegistration() {
		 LOG.info("this is the test for testShutdownMapShuffleStoreManagerSerializerAndStoreWithByteArrayKeysWithClassRegistration");
	 ...
	 @Test
	 public void testStartShutdownMapShuffleStoreManagerSerializerAndStoreWithByteArrayKeysWithRepeatedInvocation() {
		 LOG.info("this is the test for testStartShutdownMapShuffleStoreManagerSerializerAndStoreWithIntKeysWithRepeatedInvocation");
	 ...
	 public static void main(String[] args) {
	      ...
	      junit.textui.TestRunner.run(SortBasedMapSHMShuffleStoreWithByteArrayKeysTest.class);
	 }
}
