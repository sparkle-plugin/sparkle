...
public class HashBasedMapSHMShuffleStoreWithLongKeysTest extends TestCase {

	 private static final Logger LOG =
			  LoggerFactory.getLogger(HashBasedMapSHMShuffleStoreWithLongKeysTest.class.getName());
	  ...
	  */
	 @Test
	 public void testShutdownMapShuffleStoreManagerWithLongKeys() {
		 LOG.info("this is the test for shutdownMapShuffleStoreManagerWithLongKeysTest");
		 
		 int executorId = 0; 
		 ShuffleStoreManager.INSTANCE.initialize(GLOBAL_HEAP_NAME, 
				             TestRelatedConstants.maxNumberOfTaskThreads, executorId);
		 ...
		 boolean ordering= false; //no ordering, use hash based.
	 ...
	 @Test
	 public void testShutdownMapShuffleStoreManagerSerializerAndStoreWithLongKeysTestWithoutClassRegistration() {
		 
		 LOG.info("this is the test for shutdownMapShuffleStoreManagerSerializerAndStoreWithLongKeysTestWithoutClassRegistrationTest");
	 ...
	 public void testShutdownMapShuffleStoreManagerSerializerAndStoreWithIntKeysWithClassRegistration() {
		 ...
		 int numberOfPairs = numberOfVs; 
		 mapSHMShuffleStore.storeKVPairs(numberOfPairs, KValueTypeId.Long.state);
		 LOG.info("finish store the kv pairs with long keys");
		
		 ShuffleDataModel.MapStatus mapStatusResult = mapSHMShuffleStore.sortAndStore();
		 LOG.info("finish sort and store the kv paris with long keys");
	 ...
	 public static void main(String[] args) {
	      ...
	      junit.textui.TestRunner.run(HashBasedMapSHMShuffleStoreWithLongKeysTest.class);
	 }
}
