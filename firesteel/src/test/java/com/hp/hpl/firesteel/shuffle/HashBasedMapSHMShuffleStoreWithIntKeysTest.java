...
public class HashBasedMapSHMShuffleStoreWithIntKeysTest extends TestCase {

	 private static final Logger LOG =
			  LoggerFactory.getLogger(HashBasedMapSHMShuffleStoreWithIntKeysTest.class.getName());
	 ...
	 public static void main(String[] args) {
	      ...
	      junit.textui.TestRunner.run(HashBasedMapSHMShuffleStoreWithIntKeysTest.class);
	 }
}
