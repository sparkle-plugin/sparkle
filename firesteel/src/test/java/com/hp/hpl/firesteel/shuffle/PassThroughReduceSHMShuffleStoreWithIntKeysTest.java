...
public class  PassThroughReduceSHMShuffleStoreWithIntKeysTest extends TestCase {

	 private static final Logger LOG = 
			    LoggerFactory.getLogger(PassThroughReduceSHMShuffleStoreWithIntKeysTest.class.getName());
	 ...
	 public void testMapStatusFromMapShuffleStoreWithIntKeysWithReduceId1() {
		 ...
		 LOG.info("this is the test for mapStatusFromMapShuffleStoreWithIntKeysWithReduceId1Tes");
	 ...
	 @Test
	 public void testMapStatusFromMapShuffleStoreWithIntKeysWithReduceId96() {
	 ...
	 public void testMapStatusFromMapShuffleStoreWithIntKeysWithReduceId0RetrievedMultipleTimes() {
		 ...
		 do 
		 {
			 ...
			 actualRetrievedKNumbers= reduceSHMShuffleStore.getSimpleKVPairsWithIntKeys (kvalues, vvalues, knumbers);
	 ...
	 public static void main(String[] args) {
	      ...
	      junit.textui.TestRunner.run(PassThroughReduceSHMShuffleStoreWithIntKeysTest.class);
	 }
}
