...
public class  HashBasedReduceSHMShuffleStoreWithIntKeysTest extends TestCase {

	 private static final Logger LOG =
			 LoggerFactory.getLogger(HashBasedReduceSHMShuffleStoreWithIntKeysTest.class.getName());
	 ...
	 public static void main(String[] args) {
	      ...
	      junit.textui.TestRunner.run(HashBasedReduceSHMShuffleStoreWithIntKeysTest.class);
	 }
}
