...
cd $EXECUTION_PATH; mvn -Dmaven.antrun.skip -DskipJavaTests=false -DskipScalaTests=true -Dtest=com.hp.hpl.firesteel.shuffle.PassThroughReduceSHMShuffleStoreWithLongKeysTest test
