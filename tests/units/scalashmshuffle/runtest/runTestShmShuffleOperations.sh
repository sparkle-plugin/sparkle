...
cd $EXECUTION_PATH; mvn -Dmaven.antrun.skip -DskipJavaTests=true -DskipScalaTests=false -DwildcardSuites=org.apache.spark.shuffle.shm.TestShmShuffleOperations test
