...
export INPUT_FILE=/dev/shm/terasort_in
export OUTPUT_FILE=/dev/shm/terasort_out
...
$SPARK_HOME/bin/spark-submit --class "com.github.ehiggs.spark.terasort.TeraSort" --master spark://$HOST_MACHINE:7077 $JAR $INPUT_FILE $OUTPUT_FILE
