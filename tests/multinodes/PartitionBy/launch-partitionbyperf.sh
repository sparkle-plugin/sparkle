...
$SPARK_HOME/bin/spark-submit --class "org.apache.spark.examples.SparkPartitionByPerformanceTest" --master spark://$HOST_MACHINE:7077 ./target/scala-2.11/simple-partitionby-computation-project_2.11-1.0.jar
