...
$SPARK_HOME/bin/spark-submit --master spark://$HOST_MACHINE:7077 --class "org.apache.spark.examples.SparkGroupByPerformanceTestWithLong" ./target/scala-2.11/simple-groupby-computation-project_2.11-2.0.jar
